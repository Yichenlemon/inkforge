...
export const COMPONENTS: ComponentDef[] = [
  ...
  { id: 'ix-counter', name: '数字滚动', category: '交互', tags: ['counter', '数字'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'counter', panels: [{ html: '1280' }, { html: '累计用户（人）' }], width: 220, height: 120 })] },
  { id: 'ix-rotate', name: '图片旋转', category: '交互', tags: ['rotate', '旋转'], thumb: 'image',
    create: () => [B('interactive', { kind: 'rotate', panels: [{ imageUrl: '' }], width: 677, height: 220, hint: '点击旋转' })] },
  { id: 'ix-ripple', name: '水波纹', category: '交互', tags: ['ripple', '波纹'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'ripple', panels: [{ html: '点击' }], width: 200, height: 200, hint: '点击产生水波纹' })] },
  { id: 'ix-fireworks', name: '点击烟花', category: '交互', tags: ['fireworks', '烟花'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'fireworks', panels: [{ html: '绽放' }], width: 240, height: 200, hint: '点击放烟花' })] },
  { id: 'ix-snow', name: '飘雪', category: '交互', tags: ['snow', '雪'], thumb: 'image',
    create: () => [B('interactive', { kind: 'snow', panels: [], width: 677, height: 160 })] },
  { id: 'ix-bubble-rise', name: '气泡上升', category: '交互', tags: ['bubble', '气泡'], thumb: 'image',
    create: () => [B('interactive', { kind: 'bubble-rise', panels: [], width: 677, height: 160 })] },
  { id: 'ix-heart-float', name: '飘心', category: '交互', tags: ['heart', '心'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'heart-float', panels: [], width: 200, height: 200, hint: '点击飘心' })] },
  { id: 'ix-star-burst', name: '星光', category: '交互', tags: ['star', '星光'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'star-burst', panels: [], width: 200, height: 200, hint: '点击星光' })] },
  { id: 'ix-typing-dots', name: '输入中', category: '交互', tags: ['typing', '输入'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'typing-dots', panels: [{ html: '对方正在输入…' }] })] },
  { id: 'ix-shake', name: '抖动提醒', category: '交互', tags: ['shake', '抖动'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'shake', panels: [{ html: '点击抖动提醒' }], width: 677, height: 80, hint: '点击抖动' })] },
  { id: 'ix-magnifier', name: '放大镜', category: '交互', tags: ['magnifier', '放大'], thumb: 'image',
    create: () => [B('interactive', { kind: 'magnifier', panels: [{ imageUrl: '' }], width: 677, height: 240, hint: '点击放大查看' })] },
  { id: 'ix-pagination', name: '分页切换', category: '交互', tags: ['pagination', '分页'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'pagination', panels: [{ html: '第 1 页内容' }, { html: '第 2 页内容' }, { html: '第 3 页内容' }], width: 677 })] },
  { id: 'ix-steps-flow', name: '步骤条', category: '交互', tags: ['steps', '步骤'], thumb: 'list',
    create: () => [B('interactive', { kind: 'steps-flow', panels: [{ title: '第一步' }, { title: '第二步' }, { title: '第三步' }], width: 677, hint: '点击逐步点亮' })] },
  { id: 'ix-toggle-text', name: '文字切换', category: '交互', tags: ['toggle', '切换'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'toggle-text', panels: [{ html: '第一段内容' }, { html: '第二段内容' }], hint: '点击切换文字' })] },
  { id: 'ix-highlight-text', name: '划词高亮', category: '交互', tags: ['highlight', '高亮'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'highlight-text', panels: [{ html: '点击高亮这段文字的重点内容。' }], width: 677, hint: '点击高亮' })] },
  { id: 'ix-accordion-vert', name: '折叠面板', category: '交互', tags: ['accordion', '折叠'], thumb: 'list',
    create: () => [B('interactive', { kind: 'accordion-vert', panels: [{ title: '展开查看更多' }, { html: '折叠面板里的内容。' }] })] },
  { id: 'ix-spoiler', name: '剧透遮罩', category: '交互', tags: ['spoiler', '剧透'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'spoiler', panels: [{ html: '剧透预警，点击查看' }, { html: '被隐藏的真相在这里。' }] })] },
  { id: 'ix-timeline-int', name: '时间轴', category: '交互', tags: ['timeline', '时间'], thumb: 'list',
    create: () => [B('interactive', { kind: 'timeline-int', panels: [{ title: '2020', html: '起点' }, { title: '2023', html: '成长' }, { title: '2026', html: '突破' }] })] },
  { id: 'ix-confetti-rain', name: '彩带雨', category: '交互', tags: ['confetti', '彩带'], thumb: 'image',
    create: () => [B('interactive', { kind: 'confetti-rain', panels: [], width: 677, height: 160 })] },
  { id: 'ix-pulse', name: '呼吸边框', category: '交互', tags: ['pulse', '呼吸'], thumb: 'badge',
    create: () => [B('interactive', { kind: 'pulse', panels: [{ html: '重点提示' }], width: 677, height: 120 })] },
