...
import {
  ...
  FileText, Package, Copy, Download, Loader2, RefreshCw, Scissors, Star, GripVertical,
} from 'lucide-react'
...
import { assetsApi, libraryApi, convertApi, onlineApi } from '../lib/api.js'
import { toast, Tabs, Empty, Spinner, Select } from '../lib/ui.js'

type Tab = 'components' | 'assets' | 'outline' | 'library'
