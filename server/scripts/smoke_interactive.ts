...
const blocks: Block[] = [
  ...
  makeBlock('interactive', { kind: 'counter', panels: [{ html: '1280' }, { html: '累计用户' }], width: 220, height: 120 }),
  makeBlock('interactive', { kind: 'rotate', panels: [{ imageUrl: IMG(1) }], width: 677, height: 220 }),
  makeBlock('interactive', { kind: 'ripple', panels: [{ html: '点击' }], width: 200, height: 200 }),
  makeBlock('interactive', { kind: 'fireworks', panels: [{ html: '绽放' }], width: 240, height: 200 }),
  makeBlock('interactive', { kind: 'snow', panels: [], width: 677, height: 160 }),
  makeBlock('interactive', { kind: 'bubble-rise', panels: [], width: 677, height: 160 }),
  makeBlock('interactive', { kind: 'heart-float', panels: [], width: 200, height: 200 }),
  makeBlock('interactive', { kind: 'star-burst', panels: [], width: 200, height: 200 }),
  makeBlock('interactive', { kind: 'typing-dots', panels: [{ html: '对方正在输入…' }] }),
  makeBlock('interactive', { kind: 'shake', panels: [{ html: '点击抖动' }], width: 677, height: 80 }),
  makeBlock('interactive', { kind: 'magnifier', panels: [{ imageUrl: IMG(1) }], width: 677, height: 240 }),
  makeBlock('interactive', { kind: 'pagination', panels: [{ html: '第1页' }, { html: '第2页' }, { html: '第3页' }], width: 677 }),
  makeBlock('interactive', { kind: 'steps-flow', panels: [{ title: '第一步' }, { title: '第二步' }, { title: '第三步' }], width: 677 }),
  makeBlock('interactive', { kind: 'toggle-text', panels: [{ html: '第一段' }, { html: '第二段' }] }),
  makeBlock('interactive', { kind: 'highlight-text', panels: [{ html: '点击高亮这段文字' }], width: 677 }),
  makeBlock('interactive', { kind: 'accordion-vert', panels: [{ title: '展开' }, { html: '内容' }] }),
  makeBlock('interactive', { kind: 'spoiler', panels: [{ html: '剧透预警' }, { html: '真相' }] }),
  makeBlock('interactive', { kind: 'timeline-int', panels: [{ title: '2020', html: '起点' }, { title: '2023', html: '成长' }, { title: '2026', html: '突破' }] }),
  makeBlock('interactive', { kind: 'confetti-rain', panels: [], width: 677, height: 160 }),
  makeBlock('interactive', { kind: 'pulse', panels: [{ html: '重点提示' }], width: 677, height: 120 }),
]
