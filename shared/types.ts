/* 本文件是前后端共享的纯类型与纯函数模块，严禁引入任何仅在浏览器端可用、
   或含 JSX 的前端模块（如 src/lib/ui、src/store/* 的运行时），否则后端
   tsconfig（不含 jsx）会报 '--jsx' is not set。前端专属的 ActionRegistry 运行时
   请放在 src/filemgr/registry.ts。 */
...
/* ------------------------------------------------------------------ */
/* 动作注册表类型（运行时实现见 src/filemgr/registry.ts，前端专属）        */
/* ------------------------------------------------------------------ */
